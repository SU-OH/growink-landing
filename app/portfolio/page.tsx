...
export default function PortfolioPage() {
  const portfolioItems = [
    ...
    {
      title: "PostureAI 자세교정 서비스",
      category: "AI 헬스케어 웹사이트",
      image: "/images/portfolio1.png",
      year: "2024",
      results: ["자세교정 정확도 95% 달성", "사용자 만족도 4.8/5.0", "일일 활성 사용자 300% 증가"],
      tech: ["AI MediaPipe", "컴퓨터 비전", "실시간 동작 인식", "Next.js"],
      description:
        "AI MediaPipe를 활용한 실시간 자세 분석 및 교정 서비스를 개발했습니다. 웹캠을 통해 사용자의 자세를 실시간으로 분석하고, 올바른 자세로 교정할 수 있도록 가이드를 제공하는 혁신적인 헬스케어 솔루션입니다.",
    },
  ]
